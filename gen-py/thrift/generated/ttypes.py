...
class DataException(TException):
    ...
    def __init__(self, message=None, callSatck=None, data=None,):
        self.message = message
        self.callSatck = callSatck
        self.data = data
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                ...
                if ftype == TType.STRING:
                    self.callSatck = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                else:
                    iprot.skip(ftype)
            elif fid == 3:
                if ftype == TType.STRING:
    ...
    def write(self, oprot):
        ...
        if self.message is not None:
            ...
            oprot.writeFieldEnd()
        if self.callSatck is not None:
            oprot.writeFieldBegin('callSatck', TType.STRING, 2)
            oprot.writeString(self.callSatck.encode('utf-8') if sys.version_info[0] == 2 else self.callSatck)
            oprot.writeFieldEnd()
...
DataException.thrift_spec = (
    ...
    (2, TType.STRING, 'callSatck', 'UTF8', None, ),  # 2
