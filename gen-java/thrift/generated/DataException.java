...
public class DataException extends org.apache.thrift.TException implements org.apache.thrift.TBase<DataException, DataException._Fields>, java.io.Serializable, Cloneable, Comparable<DataException> {
  ...
  private static final org.apache.thrift.protocol.TField CALL_SATCK_FIELD_DESC = new org.apache.thrift.protocol.TField("callSatck", org.apache.thrift.protocol.TType.STRING, (short)2);
  ...
  private static final _Fields optionals[] = {_Fields.MESSAGE,_Fields.CALL_SATCK,_Fields.DATA};
  public static final java.util.Map<_Fields, org.apache.thrift.meta_data.FieldMetaData> metaDataMap;
  static {
    java.util.Map<_Fields, org.apache.thrift.meta_data.FieldMetaData> tmpMap = new java.util.EnumMap<_Fields, org.apache.thrift.meta_data.FieldMetaData>(_Fields.class);
    tmpMap.put(_Fields.MESSAGE, new org.apache.thrift.meta_data.FieldMetaData("message", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRING        , "String")));
    tmpMap.put(_Fields.CALL_SATCK, new org.apache.thrift.meta_data.FieldMetaData("callSatck", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRING        , "String")));
  ...
  public DataException(DataException other) {
    ...
    if (other.isSetCallSatck()) {
      this.callSatck = other.callSatck;
    }
    if (other.isSetData()) {
  ...
  @org.apache.thrift.annotation.Nullable
  public java.lang.String getCallSatck() {
    return this.callSatck;
  }

  public DataException setCallSatck(@org.apache.thrift.annotation.Nullable java.lang.String callSatck) {
    this.callSatck = callSatck;
    return this;
  }

  public void unsetCallSatck() {
    this.callSatck = null;
  }

  /** Returns true if field callSatck is set (has been assigned a value) and false otherwise */
  public boolean isSetCallSatck() {
    return this.callSatck != null;
  }

  public void setCallSatckIsSet(boolean value) {
    if (!value) {
      this.callSatck = null;
    }
  }
  ...
  public void setFieldValue(_Fields field, @org.apache.thrift.annotation.Nullable java.lang.Object value) {
    ...
    case CALL_SATCK:
      if (value == null) {
        ...
        setCallSatck((java.lang.String)value);
      }
      break;
  ...
  public boolean equals(DataException that) {
    ...
    boolean this_present_callSatck = true && this.isSetCallSatck();
    boolean that_present_callSatck = true && that.isSetCallSatck();
    if (this_present_callSatck || that_present_callSatck) {
      if (!(this_present_callSatck && that_present_callSatck))
        return false;
      if (!this.callSatck.equals(that.callSatck))
        return false;
    }
  ...
  public int hashCode() {
    ...
    hashCode = hashCode * 8191 + ((isSetCallSatck()) ? 131071 : 524287);
    if (isSetCallSatck())
      hashCode = hashCode * 8191 + callSatck.hashCode();
  ...
  public int compareTo(DataException other) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetCallSatck()).compareTo(other.isSetCallSatck());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetCallSatck()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.callSatck, other.callSatck);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  public java.lang.String toString() {
    ...
    if (isSetCallSatck()) {
      if (!first) sb.append(", ");
      sb.append("callSatck:");
      if (this.callSatck == null) {
        sb.append("null");
      } else {
        sb.append(this.callSatck);
      }
      first = false;
    }
    if (isSetData()) {
  ...
  private static class DataExceptionStandardScheme extends org.apache.thrift.scheme.StandardScheme<DataException> {
    ...
    public void read(org.apache.thrift.protocol.TProtocol iprot, DataException struct) throws org.apache.thrift.TException {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
          ...
          case 2: // CALL_SATCK
            if (schemeField.type == org.apache.thrift.protocol.TType.STRING) {
              struct.callSatck = iprot.readString();
              struct.setCallSatckIsSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, DataException struct) throws org.apache.thrift.TException {
      ...
      if (struct.callSatck != null) {
        if (struct.isSetCallSatck()) {
          oprot.writeFieldBegin(CALL_SATCK_FIELD_DESC);
          oprot.writeString(struct.callSatck);
          oprot.writeFieldEnd();
        }
      }
      if (struct.data != null) {
